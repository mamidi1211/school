...
module.exports = {
  ...
  edit: function(request, response) {
    ...
    Student.findOne({
      ...
      if (error) {
        ...
        console.log("##", student);
        response.view('student/editview', {
          name: "Edited",
          edited: student
        });
      }
  ...
  find: function(request, response) {
    ...
    Student.find().exec(function(error, students) {
      if (error) {
        ...
        return response.view('student/listView', {
  ...
  findOne: function(request, response) {
    ...
    Student.findOne({
      ...
      if (error) {
        ...
        return response.view('student/individualview', {
  ...
  populate: function(request, response) {
    ...
    Student.findOne({
      id: data
    }).populate('standard').exec(function(error, assoc) {
      if (error) {
        return response.serverError();
      } else {
        sails.log("##", assoc);
